...
class HelpCog(commands.Cog):
    ...
    async def help_cmd(self, ctx):
        ...
        response.add_field(name="!add", value="Ajoute une carte dans la base de donnée (nom, niveau, univers, force, mana, vitesse, popularite, prix, image)")
        response.add_field(name="!add_joueur", value="Ajoute une carte dans le deck d'un joueur. (nom, niveau, univers, force, mana, vitesse, popularite, joueur)")
